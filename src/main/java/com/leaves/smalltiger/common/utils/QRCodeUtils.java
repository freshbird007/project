...
//    BufferedImage是Image的实现类，是一个带缓冲区图像类，
...
//    通常用来做图片大小变换、图片变灰、设置透明不透明等。
    ...
    /*public static void main(String[] args) throws Exception {
        ...
        String text = "http://www.1000phone.com/";  //这里设置自定义网站url
        String logoPath = "D:\\Program Files\\test\\timg.jfif";//内嵌图片路径
        String destPath = "D:\\Program Files\\test\\";//生成的二维码路径
        log.info("生成的二维码名称："+QRCodeUtils.encode(text, logoPath, destPath, true));
    }*/
}
